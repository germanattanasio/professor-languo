...
/**
 * NaiveTrigramQueryGenerator generates a trigram query for the {@link Question} . The trigram query
 * retrieves the Lucene Documents whose {@link IndexDocumentFieldName#THREAD_TITLE} field contains
 * any trigram token of the {@link Question}'s title field.
 */
public class NaiveTrigramQueryGenerator extends NaiveQueryGenerator {
  ...
  @Override public Query generateQuery(Question question) throws SearchException {
    return createNaiveNgramQuery(question, 3);
  }

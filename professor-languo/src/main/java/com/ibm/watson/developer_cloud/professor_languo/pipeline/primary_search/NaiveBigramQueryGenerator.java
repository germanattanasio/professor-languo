...
/**
 * Create a naive bigram query for the {@link Question}. The naive bigram query retrieves the Lucene
 * Documents whose {@link IndexDocumentFieldName#THREAD_TITLE} field contains any bigram token of
 * the {@link Question}'s title field.
 */
public class NaiveBigramQueryGenerator extends NaiveQueryGenerator {
  ...
  @Override public Query generateQuery(Question question) throws SearchException {
    return createNaiveNgramQuery(question, 2);
  }

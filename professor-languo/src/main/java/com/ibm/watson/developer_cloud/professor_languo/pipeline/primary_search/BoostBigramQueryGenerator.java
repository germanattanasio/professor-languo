...
/**
 * BoostBigramQueryGenerator generates a boost bigram query for the {@link Question}. The boost
 * bigram query retrieves the Lucene Documents whose {@link IndexDocumentFieldName#THREAD_TITLE}
 ...
 * {@link IndexDocumentFieldName#TOP_VOTED_ANSWER_TEXT} field contains any bigram token of the
 ...
 * 
 */
public class BoostBigramQueryGenerator extends BoostQueryGenerator {
  ...
  @Override public Query generateQuery(Question question) throws SearchException {
    return createBoostNgramQuery(question, 2);
  }

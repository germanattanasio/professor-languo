...
public class Messages {
  ...
  public static final Logger log = LogManager.getLogger(Messages.class.getName());
  ...
  public static String getString(String key) {
    ...
    try {
      ...
      // fallback to English as something seems to be amiss with the
      // property bundle
      log.error(MessageFormat.format("Failed to load value for key {0} due to UTF-8 encoding issue.", key), e); //$NON-NLS-1$

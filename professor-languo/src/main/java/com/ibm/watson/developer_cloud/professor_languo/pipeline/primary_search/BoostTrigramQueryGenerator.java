...
/**
 * BoostTrigramQueryGenerator generates a boost trigram query for the {@link Question}. The boost
 * trigram query retrieves the Lucene Documents whose {@link IndexDocumentFieldName#THREAD_TITLE}
 ...
 * {@link IndexDocumentFieldName#TOP_VOTED_ANSWER_TEXT} field contains any trigram token of the
 ...
 * 
 */
public class BoostTrigramQueryGenerator extends BoostQueryGenerator {
  ...
  @Override public Query generateQuery(Question question) throws SearchException {
    return createBoostNgramQuery(question, 3);
  }

...
public class NumberOfAnswersFeatureScorerTest extends BaseEgaAnswerScorerTests {
  NumberOfAnswersFeatureScorerTest GIVEN = this, WHEN = this, THEN = this, OR = this, AND = this;
  ...
  private void reference_feature_score_pair_produced() {
    ...
    referenceFeatureScorePair = new FeatureScorePair(FeatureScorerEnums.NUMBER_OF_ANSWERS_FEATURE_SCORER.toString(),
        new NumberOfAnswersFeatureScorer().transformScore(score));
  }

  private void feature_score_pair_produced() throws AnswerScorerException {
    // TODO Auto-generated method stub
    EgaMetaDataScorerComponent metaDataScorerComponent = new NumberOfAnswersFeatureScorer();
    metaDataScorerComponent.generateFeatureScore(candidateAnswers[0]);
    featureScorePair = new FeatureScorePair(FeatureScorerEnums.NUMBER_OF_ANSWERS_FEATURE_SCORER.toString(),
        candidateAnswers[0].getFeatureValue(FeatureScorerEnums.NUMBER_OF_ANSWERS_FEATURE_SCORER.toString()));
  }

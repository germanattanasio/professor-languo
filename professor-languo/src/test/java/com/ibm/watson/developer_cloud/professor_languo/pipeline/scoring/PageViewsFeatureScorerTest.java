...
public class PageViewsFeatureScorerTest extends BaseEgaAnswerScorerTests {
  PageViewsFeatureScorerTest GIVEN = this, WHEN = this, THEN = this, OR = this, AND = this;
  ...
  private void reference_feature_score_pair_produced() {
    ...
    referenceFeatureScorePair = new FeatureScorePair(FeatureScorerEnums.PAGE_VIEWS_FEATURE_SCORER.toString(),
        new PageViewsFeatureScorer().transformScore(score));
  }

  private void feature_score_pair_produced() throws AnswerScorerException {
    // TODO Auto-generated method stub
    EgaMetaDataScorerComponent metaDataScorerComponent = new PageViewsFeatureScorer();
    metaDataScorerComponent.generateFeatureScore(candidateAnswers[0]);
    featureScorePair = new FeatureScorePair(FeatureScorerEnums.PAGE_VIEWS_FEATURE_SCORER.toString(),
        candidateAnswers[0].getFeatureValue(FeatureScorerEnums.PAGE_VIEWS_FEATURE_SCORER.toString()));
  }

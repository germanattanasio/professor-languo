...
public class AllAnswersVoteRatioFeatureScorerTest extends BaseEgaAnswerScorerTests {
  AllAnswersVoteRatioFeatureScorerTest GIVEN = this, WHEN = this, THEN = this, OR = this, AND = this;
  ...
  private void reference_feature_score_pair_produced() {
    ...
    long answerUpVotesCount = 10;
    long answerDownVotesCount = 7;
    ...
    referenceFeatureScorePair =
        new FeatureScorePair(FeatureScorerEnums.ALL_ANSWERS_VOTE_RATIO_FEATURE_SCORER.toString(),
            new AllAnswersVoteRatioFeatureScorer().transformScore(score));
  }

  private void feature_score_pair_produced() throws AnswerScorerException {
    // TODO Auto-generated method stub
    EgaMetaDataScorerComponent metaDataScorerComponent = new AllAnswersVoteRatioFeatureScorer();
    metaDataScorerComponent.generateFeatureScore(candidateAnswers[0]);
    featureScorePair = new FeatureScorePair(FeatureScorerEnums.ALL_ANSWERS_VOTE_RATIO_FEATURE_SCORER.toString(),
        candidateAnswers[0].getFeatureValue(FeatureScorerEnums.ALL_ANSWERS_VOTE_RATIO_FEATURE_SCORER.toString()));
  }
